...
static const FName NAME_AOnlineBeaconClient_ClientOnConnected = FName(TEXT("ClientOnConnected"));
...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeaconClient_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AOnlineBeaconClient, AOnlineBeaconClient::StaticClass, TEXT("AOnlineBeaconClient"), &Z_Registration_Info_UClass_AOnlineBeaconClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AOnlineBeaconClient), 3879544859U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeaconClient_h_2477108536(TEXT("/Script/OnlineSubsystemUtils"),

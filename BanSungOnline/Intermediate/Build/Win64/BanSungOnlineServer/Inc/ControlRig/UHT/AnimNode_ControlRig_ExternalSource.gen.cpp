...
UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_ControlRig_ExternalSource()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_AnimNode_ControlRig_ExternalSource.InnerSingleton, Z_Construct_UScriptStruct_FAnimNode_ControlRig_ExternalSource_Statics::StructParams);
	}
...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_AnimNode_ControlRig_ExternalSource_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FAnimNode_ControlRig_ExternalSource::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_ControlRig_ExternalSource_Statics::NewStructOps, TEXT("AnimNode_ControlRig_ExternalSource"), &Z_Registration_Info_UScriptStruct_AnimNode_ControlRig_ExternalSource, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_ControlRig_ExternalSource), 2050876072U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_AnimNode_ControlRig_ExternalSource_h_3345144276(TEXT("/Script/ControlRig"),
	nullptr, 0,

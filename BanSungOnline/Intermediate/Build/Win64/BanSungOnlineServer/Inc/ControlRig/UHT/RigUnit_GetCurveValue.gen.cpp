...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Hierarchy_RigUnit_GetCurveValue_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FRigUnit_GetCurveValue::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewStructOps, TEXT("RigUnit_GetCurveValue"), &Z_Registration_Info_UScriptStruct_RigUnit_GetCurveValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetCurveValue), 3659048842U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Hierarchy_RigUnit_GetCurveValue_h_1242024236(TEXT("/Script/ControlRig"),
	nullptr, 0,

...
#include "StateTreeModule/Public/IStateTreeSchemaProvider.h"
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UStateTreeSchemaProvider);
UClass* Z_Construct_UClass_UStateTreeSchemaProvider_NoRegister()
{
	return UStateTreeSchemaProvider::StaticClass();
}
...
template<> STATETREEMODULE_API UClass* StaticClass<UStateTreeSchemaProvider>()
{
	return UStateTreeSchemaProvider::StaticClass();
}
UStateTreeSchemaProvider::UStateTreeSchemaProvider(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
DEFINE_VTABLE_PTR_HELPER_CTOR(UStateTreeSchemaProvider);
UStateTreeSchemaProvider::~UStateTreeSchemaProvider() {}
// End Interface UStateTreeSchemaProvider

// Begin Registration
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_IStateTreeSchemaProvider_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UStateTreeSchemaProvider, UStateTreeSchemaProvider::StaticClass, TEXT("UStateTreeSchemaProvider"), &Z_Registration_Info_UClass_UStateTreeSchemaProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStateTreeSchemaProvider), 3272212049U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_IStateTreeSchemaProvider_h_633125415(TEXT("/Script/StateTreeModule"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_IStateTreeSchemaProvider_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_IStateTreeSchemaProvider_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration

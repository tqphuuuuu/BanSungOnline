...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_ControlPointMeshActor_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AControlPointMeshActor, AControlPointMeshActor::StaticClass, TEXT("AControlPointMeshActor"), &Z_Registration_Info_UClass_AControlPointMeshActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AControlPointMeshActor), 3852203266U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_ControlPointMeshActor_h_3926198314(TEXT("/Script/Landscape"),

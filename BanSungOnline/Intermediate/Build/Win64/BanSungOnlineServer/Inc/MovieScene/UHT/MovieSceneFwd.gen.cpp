...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneFwd_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EMovieScenePlayerStatus_StaticEnum, TEXT("EMovieScenePlayerStatus"), &Z_Registration_Info_UEnum_EMovieScenePlayerStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 421320725U) },
		...
		{ EMovieSceneSequenceFlags_StaticEnum, TEXT("EMovieSceneSequenceFlags"), &Z_Registration_Info_UEnum_EMovieSceneSequenceFlags, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1333378673U) },
		{ EMovieSceneServerClientMask_StaticEnum, TEXT("EMovieSceneServerClientMask"), &Z_Registration_Info_UEnum_EMovieSceneServerClientMask, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 175582949U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneFwd_h_3006514575(TEXT("/Script/MovieScene"),
	nullptr, 0,
	nullptr, 0,

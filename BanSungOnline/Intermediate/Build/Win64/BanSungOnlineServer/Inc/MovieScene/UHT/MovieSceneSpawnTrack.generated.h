...
public: \
	DECLARE_CLASS(UMovieSceneSpawnTrack, UMovieSceneTrack, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MovieScene"), MOVIESCENE_API) \
...
private: \
	...
	UMovieSceneSpawnTrack(const UMovieSceneSpawnTrack&); \
public: \

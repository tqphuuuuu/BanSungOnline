...
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneTangentData_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneTangentData_Statics::StructParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneTangentData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMovieSceneTangentData_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneTangentData()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_MovieSceneTangentData.InnerSingleton, Z_Construct_UScriptStruct_FMovieSceneTangentData_Statics::StructParams);
	}
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Channels_MovieSceneCurveChannelCommon_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMovieSceneTangentData::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneTangentData_Statics::NewStructOps, TEXT("MovieSceneTangentData"), &Z_Registration_Info_UScriptStruct_MovieSceneTangentData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneTangentData), 4158658663U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Channels_MovieSceneCurveChannelCommon_h_3376588963(TEXT("/Script/MovieScene"),
	nullptr, 0,

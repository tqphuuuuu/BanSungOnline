...
#include "Runtime/MovieScene/Public/EntitySystem/MovieSceneBlenderSystem.h"
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_MovieSceneBlenderSystem_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneBlenderSystem, UMovieSceneBlenderSystem::StaticClass, TEXT("UMovieSceneBlenderSystem"), &Z_Registration_Info_UClass_UMovieSceneBlenderSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneBlenderSystem), 3743216563U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_MovieSceneBlenderSystem_h_3888807721(TEXT("/Script/MovieScene"),

...
public: \
	DECLARE_CLASS(UAIDataProvider, UObject, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/AIModule"), AIMODULE_API) \
...
private: \
	...
	UAIDataProvider(const UAIDataProvider&); \
public: \

...
static const FName NAME_UEnvQueryGenerator_BlueprintBase_DoItemGeneration = FName(TEXT("DoItemGeneration"));
void UEnvQueryGenerator_BlueprintBase::DoItemGeneration(TArray<FVector> const& ContextLocations) const
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UEnvQueryGenerator_BlueprintBase_DoItemGeneration);
		const_cast<UEnvQueryGenerator_BlueprintBase*>(this)->ProcessEvent(Func,&Parms);
}
...
static const FName NAME_UEnvQueryGenerator_BlueprintBase_DoItemGenerationFromActors = FName(TEXT("DoItemGenerationFromActors"));
void UEnvQueryGenerator_BlueprintBase::DoItemGenerationFromActors(TArray<AActor*> const& ContextActors) const
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UEnvQueryGenerator_BlueprintBase_DoItemGenerationFromActors);
		const_cast<UEnvQueryGenerator_BlueprintBase*>(this)->ProcessEvent(Func,&Parms);
}
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_EnvironmentQuery_Generators_EnvQueryGenerator_BlueprintBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQueryGenerator_BlueprintBase, UEnvQueryGenerator_BlueprintBase::StaticClass, TEXT("UEnvQueryGenerator_BlueprintBase"), &Z_Registration_Info_UClass_UEnvQueryGenerator_BlueprintBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQueryGenerator_BlueprintBase), 3076001781U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_EnvironmentQuery_Generators_EnvQueryGenerator_BlueprintBase_h_486272777(TEXT("/Script/AIModule"),

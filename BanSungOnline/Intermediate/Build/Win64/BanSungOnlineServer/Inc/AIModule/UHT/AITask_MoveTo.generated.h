...
public: \
	DECLARE_CLASS(UAITask_MoveTo, UAITask, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/AIModule"), AIMODULE_API) \
...
private: \
	...
	UAITask_MoveTo(const UAITask_MoveTo&); \
public: \

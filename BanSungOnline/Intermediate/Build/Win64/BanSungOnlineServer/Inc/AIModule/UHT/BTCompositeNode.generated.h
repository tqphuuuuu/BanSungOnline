...
public: \
	DECLARE_CLASS(UBTCompositeNode, UBTNode, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/AIModule"), AIMODULE_API) \
...
private: \
	...
	UBTCompositeNode(const UBTCompositeNode&); \
public:

...
public: \
	DECLARE_CLASS(UAIPerceptionComponent, UActorComponent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/AIModule"), AIMODULE_API) \
...
private: \
	...
	UAIPerceptionComponent(const UAIPerceptionComponent&); \
public: \

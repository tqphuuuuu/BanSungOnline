...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_OverlaySlot_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOverlaySlot, UOverlaySlot::StaticClass, TEXT("UOverlaySlot"), &Z_Registration_Info_UClass_UOverlaySlot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOverlaySlot), 3637610493U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_OverlaySlot_h_3355950400(TEXT("/Script/UMG"),

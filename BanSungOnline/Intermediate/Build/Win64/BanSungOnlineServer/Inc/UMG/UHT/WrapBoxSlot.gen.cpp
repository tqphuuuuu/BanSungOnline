...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_WrapBoxSlot_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UWrapBoxSlot, UWrapBoxSlot::StaticClass, TEXT("UWrapBoxSlot"), &Z_Registration_Info_UClass_UWrapBoxSlot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWrapBoxSlot), 3401794551U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_WrapBoxSlot_h_1669369387(TEXT("/Script/UMG"),

...
private: \
	...
	UNamedSlotInterface(const UNamedSlotInterface&); \
public: \
	UMG_API virtual ~UNamedSlotInterface();
...
public: \
	DECLARE_CLASS(UNamedSlotInterface, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/UMG"), UMG_API) \

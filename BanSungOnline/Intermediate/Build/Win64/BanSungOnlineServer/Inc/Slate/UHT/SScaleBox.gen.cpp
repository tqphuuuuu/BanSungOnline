...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Slate_Public_Widgets_Layout_SScaleBox_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EStretchDirection_StaticEnum, TEXT("EStretchDirection"), &Z_Registration_Info_UEnum_EStretchDirection, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2532123891U) },
		{ EStretch_StaticEnum, TEXT("EStretch"), &Z_Registration_Info_UEnum_EStretch, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1637697150U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Slate_Public_Widgets_Layout_SScaleBox_h_2224327530(TEXT("/Script/Slate"),
	nullptr, 0,
	nullptr, 0,

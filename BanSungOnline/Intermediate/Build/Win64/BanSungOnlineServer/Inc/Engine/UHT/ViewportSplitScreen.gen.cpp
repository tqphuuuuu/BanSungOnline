...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Engine_ESplitScreenType_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_ESplitScreenType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Engine_ESplitScreenType_Statics::Enum_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_ViewportSplitScreen_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESplitScreenType_StaticEnum, TEXT("ESplitScreenType"), &Z_Registration_Info_UEnum_ESplitScreenType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3788073261U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_ViewportSplitScreen_h_1755964893(TEXT("/Script/Engine"),
	nullptr, 0,
	nullptr, 0,

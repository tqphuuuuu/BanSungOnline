...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Engine_ETimeStretchCurveMapping_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_ETimeStretchCurveMapping_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Engine_ETimeStretchCurveMapping_Statics::Enum_MetaDataParams)
};
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurveMarker_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(Time, FTimeStretchCurveMarker), STRUCT_OFFSET(FTimeStretchCurveMarker, Time), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Time_MetaData), NewProp_Time_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurveMarker_Statics::NewProp_Alpha = { "Alpha", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTimeStretchCurveMarker, Alpha), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Alpha_MetaData), NewProp_Alpha_MetaData) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeStretchCurveMarker_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTimeStretchCurveMarker_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_Engine,
	nullptr,
	&NewStructOps,
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeStretchCurveMarker_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTimeStretchCurveMarker_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FTimeStretchCurveMarker()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_TimeStretchCurveMarker.InnerSingleton, Z_Construct_UScriptStruct_FTimeStretchCurveMarker_Statics::StructParams);
	}
...
struct Z_Construct_UScriptStruct_FTimeStretchCurve_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_CurveValueMinPrecision_MetaData[] = {
		{ "Category", "TimeStretchCurve" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Sum_dT_i_by_C_i_MetaData[] = {
		{ "ArraySizeEnum", "/Script/Engine.ETimeStretchCurveMapping" },
		{ "Category", "TimeStretchCurve" },
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewProp_SamplingRate = { "SamplingRate", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTimeStretchCurve, SamplingRate), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SamplingRate_MetaData), NewProp_SamplingRate_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewProp_CurveValueMinPrecision = { "CurveValueMinPrecision", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTimeStretchCurve, CurveValueMinPrecision), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CurveValueMinPrecision_MetaData), NewProp_CurveValueMinPrecision_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewProp_Markers_Inner = { "Markers", nullptr, (EPropertyFlags)0x0000000000020000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FTimeStretchCurveMarker, METADATA_PARAMS(0, nullptr) }; // 3147867618
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewProp_Markers = { "Markers", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTimeStretchCurve, Markers), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Markers_MetaData), NewProp_Markers_MetaData) }; // 3147867618
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewProp_Sum_dT_i_by_C_i = { "Sum_dT_i_by_C_i", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(Sum_dT_i_by_C_i, FTimeStretchCurve), STRUCT_OFFSET(FTimeStretchCurve, Sum_dT_i_by_C_i), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Sum_dT_i_by_C_i_MetaData), NewProp_Sum_dT_i_by_C_i_MetaData) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_Engine,
	nullptr,
	&NewStructOps,
	"TimeStretchCurve",
	...
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000001),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FTimeStretchCurve()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_TimeStretchCurve.InnerSingleton, Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::StructParams);
	}
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::NewProp_bHasValidData = { "bHasValidData", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FTimeStretchCurveInstance), &Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::NewProp_bHasValidData_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bHasValidData_MetaData), NewProp_bHasValidData_MetaData) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_Engine,
	nullptr,
	&NewStructOps,
	...
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000001),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FTimeStretchCurveInstance()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_TimeStretchCurveInstance.InnerSingleton, Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::StructParams);
	}
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_TimeStretchCurve_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ETimeStretchCurveMapping_StaticEnum, TEXT("ETimeStretchCurveMapping"), &Z_Registration_Info_UEnum_ETimeStretchCurveMapping, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2389659717U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FTimeStretchCurveMarker::StaticStruct, Z_Construct_UScriptStruct_FTimeStretchCurveMarker_Statics::NewStructOps, TEXT("TimeStretchCurveMarker"), &Z_Registration_Info_UScriptStruct_TimeStretchCurveMarker, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTimeStretchCurveMarker), 3147867618U) },
		{ FTimeStretchCurve::StaticStruct, Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewStructOps, TEXT("TimeStretchCurve"), &Z_Registration_Info_UScriptStruct_TimeStretchCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTimeStretchCurve), 2339713338U) },
		{ FTimeStretchCurveInstance::StaticStruct, Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::NewStructOps, TEXT("TimeStretchCurveInstance"), &Z_Registration_Info_UScriptStruct_TimeStretchCurveInstance, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTimeStretchCurveInstance), 4157241102U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_TimeStretchCurve_h_3435856604(TEXT("/Script/Engine"),
	nullptr, 0,

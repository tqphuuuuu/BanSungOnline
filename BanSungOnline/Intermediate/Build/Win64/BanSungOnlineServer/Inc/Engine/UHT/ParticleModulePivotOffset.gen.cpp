...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModulePivotOffset_Statics::PropPointers) < 2048);
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModulePivotOffset_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_UParticleModulePivotOffset_Statics::ClassParams = {
	...
	0,
	0x000810A0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModulePivotOffset_Statics::Class_MetaDataParams), Z_Construct_UClass_UParticleModulePivotOffset_Statics::Class_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Modules_Location_ParticleModulePivotOffset_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModulePivotOffset, UParticleModulePivotOffset::StaticClass, TEXT("UParticleModulePivotOffset"), &Z_Registration_Info_UClass_UParticleModulePivotOffset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModulePivotOffset), 1800004993U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Modules_Location_ParticleModulePivotOffset_h_437685726(TEXT("/Script/Engine"),

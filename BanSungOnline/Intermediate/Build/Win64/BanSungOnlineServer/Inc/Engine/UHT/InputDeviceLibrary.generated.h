...
public: \
	DECLARE_CLASS(UInputDeviceLibrary, UBlueprintFunctionLibrary, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), ENGINE_API) \
...
private: \
	...
	UInputDeviceLibrary(const UInputDeviceLibrary&); \
public: \

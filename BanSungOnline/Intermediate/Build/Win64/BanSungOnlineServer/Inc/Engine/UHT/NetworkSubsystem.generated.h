...
public: \
	DECLARE_CLASS(UNetworkSubsystem, UWorldSubsystem, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), ENGINE_API) \
...
private: \
	...
	UNetworkSubsystem(const UNetworkSubsystem&); \
public: \

...
struct Z_Construct_UScriptStruct_FHitResult_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_HitObjectHandle_MetaData[] = {
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FHitResult_Statics::NewProp_FaceIndex = { "FaceIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHitResult, FaceIndex), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FaceIndex_MetaData), NewProp_FaceIndex_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FHitResult_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHitResult, Time), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Time_MetaData), NewProp_Time_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FHitResult_Statics::NewProp_Distance = { "Distance", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHitResult, Distance), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Distance_MetaData), NewProp_Distance_MetaData) };
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHitResult_Statics::NewProp_Normal = { "Normal", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHitResult, Normal), Z_Construct_UScriptStruct_FVector_NetQuantizeNormal, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Normal_MetaData), NewProp_Normal_MetaData) }; // 1520846145
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHitResult_Statics::NewProp_ImpactNormal = { "ImpactNormal", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHitResult, ImpactNormal), Z_Construct_UScriptStruct_FVector_NetQuantizeNormal, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ImpactNormal_MetaData), NewProp_ImpactNormal_MetaData) }; // 1520846145
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHitResult_Statics::NewProp_TraceStart = { "TraceStart", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHitResult, TraceStart), Z_Construct_UScriptStruct_FVector_NetQuantize, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TraceStart_MetaData), NewProp_TraceStart_MetaData) }; // 1723029535
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHitResult_Statics::NewProp_TraceEnd = { "TraceEnd", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHitResult, TraceEnd), Z_Construct_UScriptStruct_FVector_NetQuantize, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TraceEnd_MetaData), NewProp_TraceEnd_MetaData) }; // 1723029535
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FHitResult_Statics::NewProp_PenetrationDepth = { "PenetrationDepth", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHitResult, PenetrationDepth), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PenetrationDepth_MetaData), NewProp_PenetrationDepth_MetaData) };
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHitResult_Statics::NewProp_HitObjectHandle = { "HitObjectHandle", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHitResult, HitObjectHandle), Z_Construct_UScriptStruct_FActorInstanceHandle, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HitObjectHandle_MetaData), NewProp_HitObjectHandle_MetaData) }; // 2065137789
const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UScriptStruct_FHitResult_Statics::NewProp_Component = { "Component", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHitResult, Component), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Component_MetaData), NewProp_Component_MetaData) };
const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FHitResult_Statics::NewProp_BoneName = { "BoneName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHitResult, BoneName), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BoneName_MetaData), NewProp_BoneName_MetaData) };
const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FHitResult_Statics::NewProp_MyBoneName = { "MyBoneName", nullptr, (EPropertyFlags)0x0010000080000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHitResult, MyBoneName), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MyBoneName_MetaData), NewProp_MyBoneName_MetaData) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHitResult_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FHitResult_Statics::StructParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHitResult_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FHitResult_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FHitResult()
{
	if (!Z_Registration_Info_UScriptStruct_HitResult.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_HitResult.InnerSingleton, Z_Construct_UScriptStruct_FHitResult_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_HitResult.InnerSingleton;
}
// End ScriptStruct FHitResult

// Begin Registration
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_HitResult_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FHitResult::StaticStruct, Z_Construct_UScriptStruct_FHitResult_Statics::NewStructOps, TEXT("HitResult"), &Z_Registration_Info_UScriptStruct_HitResult, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHitResult), 4100991306U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_HitResult_h_2142849455(TEXT("/Script/Engine"),
	nullptr, 0,

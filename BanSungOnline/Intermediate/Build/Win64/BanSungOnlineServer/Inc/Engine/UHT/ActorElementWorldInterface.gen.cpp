...
#include "Runtime/Engine/Public/Elements/Actor/ActorElementWorldInterface.h"
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UActorElementWorldInterface_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UTypedElementWorldInterface_NoRegister, (int32)VTABLE_OFFSET(UActorElementWorldInterface, ITypedElementWorldInterface), false },  // 2524139720
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Elements_Actor_ActorElementWorldInterface_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UActorElementWorldInterface, UActorElementWorldInterface::StaticClass, TEXT("UActorElementWorldInterface"), &Z_Registration_Info_UClass_UActorElementWorldInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActorElementWorldInterface), 4219578841U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Elements_Actor_ActorElementWorldInterface_h_4216198632(TEXT("/Script/Engine"),

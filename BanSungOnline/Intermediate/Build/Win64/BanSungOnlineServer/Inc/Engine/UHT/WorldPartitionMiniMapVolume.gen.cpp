...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionMiniMapVolume_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AWorldPartitionMiniMapVolume, AWorldPartitionMiniMapVolume::StaticClass, TEXT("AWorldPartitionMiniMapVolume"), &Z_Registration_Info_UClass_AWorldPartitionMiniMapVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWorldPartitionMiniMapVolume), 1382800223U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionMiniMapVolume_h_3375601756(TEXT("/Script/Engine"),

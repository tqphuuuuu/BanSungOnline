...
struct Z_Construct_UEnum_Engine_ESceneTextureId_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "PPI_UserSceneTexture0.Comment", "/** Used internally for user scene texture inputs.  Later remapped to PPI_PostProcessInput0-6 in the shader via procedurally generated defines. */" },
		{ "PPI_UserSceneTexture0.Hidden", "" },
		{ "PPI_UserSceneTexture0.Name", "PPI_UserSceneTexture0" },
		{ "PPI_UserSceneTexture0.ToolTip", "Used internally for user scene texture inputs.  Later remapped to PPI_PostProcessInput0-6 in the shader via procedurally generated defines." },
		{ "PPI_UserSceneTexture1.Hidden", "" },
		{ "PPI_UserSceneTexture1.Name", "PPI_UserSceneTexture1" },
		{ "PPI_UserSceneTexture2.Hidden", "" },
		{ "PPI_UserSceneTexture2.Name", "PPI_UserSceneTexture2" },
		{ "PPI_UserSceneTexture3.Hidden", "" },
		{ "PPI_UserSceneTexture3.Name", "PPI_UserSceneTexture3" },
		{ "PPI_UserSceneTexture4.Hidden", "" },
		{ "PPI_UserSceneTexture4.Name", "PPI_UserSceneTexture4" },
		{ "PPI_UserSceneTexture5.Hidden", "" },
		{ "PPI_UserSceneTexture5.Name", "PPI_UserSceneTexture5" },
		{ "PPI_UserSceneTexture6.Hidden", "" },
		{ "PPI_UserSceneTexture6.Name", "PPI_UserSceneTexture6" },
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "PPI_UserSceneTexture0", (int64)PPI_UserSceneTexture0 },
		{ "PPI_UserSceneTexture1", (int64)PPI_UserSceneTexture1 },
		{ "PPI_UserSceneTexture2", (int64)PPI_UserSceneTexture2 },
		{ "PPI_UserSceneTexture3", (int64)PPI_UserSceneTexture3 },
		{ "PPI_UserSceneTexture4", (int64)PPI_UserSceneTexture4 },
		{ "PPI_UserSceneTexture5", (int64)PPI_UserSceneTexture5 },
		{ "PPI_UserSceneTexture6", (int64)PPI_UserSceneTexture6 },
	};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialSceneTextureId_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESceneTextureId_StaticEnum, TEXT("ESceneTextureId"), &Z_Registration_Info_UEnum_ESceneTextureId, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2799008013U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialSceneTextureId_h_4113002964(TEXT("/Script/Engine"),
	nullptr, 0,
	nullptr, 0,

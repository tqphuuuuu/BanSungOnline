...
#include "Runtime/Engine/Public/Net/OnlineEngineInterface.h"
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Net_OnlineEngineInterface_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOnlineEngineInterface, UOnlineEngineInterface::StaticClass, TEXT("UOnlineEngineInterface"), &Z_Registration_Info_UClass_UOnlineEngineInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOnlineEngineInterface), 4038489810U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Net_OnlineEngineInterface_h_624036578(TEXT("/Script/Engine"),

...
#include "Runtime/Engine/Public/Elements/Object/ObjectElementAssetDataInterface.h"
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UObjectElementAssetDataInterface_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UObjectElementAssetDataInterface_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UTypedElementAssetDataInterface_NoRegister, (int32)VTABLE_OFFSET(UObjectElementAssetDataInterface, ITypedElementAssetDataInterface), false },  // 1816171463
};
const UECodeGen_Private::FClassParams Z_Construct_UClass_UObjectElementAssetDataInterface_Statics::ClassParams = {
	...
	0x000800A0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UObjectElementAssetDataInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UObjectElementAssetDataInterface_Statics::Class_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Elements_Object_ObjectElementAssetDataInterface_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UObjectElementAssetDataInterface, UObjectElementAssetDataInterface::StaticClass, TEXT("UObjectElementAssetDataInterface"), &Z_Registration_Info_UClass_UObjectElementAssetDataInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UObjectElementAssetDataInterface), 1103000507U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Elements_Object_ObjectElementAssetDataInterface_h_3523904599(TEXT("/Script/Engine"),

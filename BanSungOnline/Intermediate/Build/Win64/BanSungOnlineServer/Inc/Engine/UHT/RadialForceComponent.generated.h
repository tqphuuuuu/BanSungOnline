...
public: \
	DECLARE_CLASS(URadialForceComponent, USceneComponent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), ENGINE_API) \
...
private: \
	...
	URadialForceComponent(const URadialForceComponent&); \
public: \

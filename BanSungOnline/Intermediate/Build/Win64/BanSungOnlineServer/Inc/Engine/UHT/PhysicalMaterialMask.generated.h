...
public: \
	DECLARE_CLASS(UPhysicalMaterialMask, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), ENGINE_API) \
...
private: \
	...
	UPhysicalMaterialMask(const UPhysicalMaterialMask&); \
public:

...
public: \
	DECLARE_CLASS(UDataStreamChannel, UChannel, COMPILED_IN_FLAGS(0 | CLASS_Transient), CASTCLASS_None, TEXT("/Script/Engine"), ENGINE_API) \
...
private: \
	...
	UDataStreamChannel(const UDataStreamChannel&); \
public: \

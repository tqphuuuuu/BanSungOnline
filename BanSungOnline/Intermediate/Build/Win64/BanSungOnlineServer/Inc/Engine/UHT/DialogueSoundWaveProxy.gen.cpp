...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_DialogueSoundWaveProxy_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDialogueSoundWaveProxy, UDialogueSoundWaveProxy::StaticClass, TEXT("UDialogueSoundWaveProxy"), &Z_Registration_Info_UClass_UDialogueSoundWaveProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogueSoundWaveProxy), 2188050615U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_DialogueSoundWaveProxy_h_1912604436(TEXT("/Script/Engine"),

...
public: \
	DECLARE_CLASS(UDebugDrawService, UBlueprintFunctionLibrary, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), ENGINE_API) \
...
private: \
	...
	UDebugDrawService(const UDebugDrawService&); \
public: \

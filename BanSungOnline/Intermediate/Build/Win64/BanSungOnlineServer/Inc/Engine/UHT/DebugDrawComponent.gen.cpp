...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Debug_DebugDrawComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDebugDrawComponent, UDebugDrawComponent::StaticClass, TEXT("UDebugDrawComponent"), &Z_Registration_Info_UClass_UDebugDrawComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDebugDrawComponent), 3688463766U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Debug_DebugDrawComponent_h_1510189071(TEXT("/Script/Engine"),

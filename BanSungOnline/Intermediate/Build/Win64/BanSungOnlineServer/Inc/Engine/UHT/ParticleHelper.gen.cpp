...
struct Z_Construct_UEnum_Engine_EParticleDetailMode_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "PDM_Epic.DisplayName", "Epic" },
		{ "PDM_Epic.Name", "PDM_Epic" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Engine_EParticleDetailMode_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_EParticleDetailMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Engine_EParticleDetailMode_Statics::Enum_MetaDataParams)
};
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Engine_EParticleSignificanceLevel_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_EParticleSignificanceLevel_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Engine_EParticleSignificanceLevel_Statics::Enum_MetaDataParams)
};
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Engine_EParticleSystemInsignificanceReaction_Statics::EnumParams = {
	...
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_EParticleSystemInsignificanceReaction_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Engine_EParticleSystemInsignificanceReaction_Statics::Enum_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_ParticleHelper_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EParticleDetailMode_StaticEnum, TEXT("EParticleDetailMode"), &Z_Registration_Info_UEnum_EParticleDetailMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3764092425U) },
		{ EParticleSignificanceLevel_StaticEnum, TEXT("EParticleSignificanceLevel"), &Z_Registration_Info_UEnum_EParticleSignificanceLevel, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3456169590U) },
		{ EParticleSystemInsignificanceReaction_StaticEnum, TEXT("EParticleSystemInsignificanceReaction"), &Z_Registration_Info_UEnum_EParticleSystemInsignificanceReaction, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3722448032U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_ParticleHelper_h_1553349564(TEXT("/Script/Engine"),
	nullptr, 0,
	nullptr, 0,

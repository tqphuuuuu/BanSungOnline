...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Engine_ESoundWaveLoadingBehavior_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_ESoundWaveLoadingBehavior_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Engine_ESoundWaveLoadingBehavior_Statics::Enum_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundWaveLoadingBehavior_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESoundWaveLoadingBehavior_StaticEnum, TEXT("ESoundWaveLoadingBehavior"), &Z_Registration_Info_UEnum_ESoundWaveLoadingBehavior, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2688492422U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundWaveLoadingBehavior_h_3953051775(TEXT("/Script/Engine"),
	nullptr, 0,
	nullptr, 0,

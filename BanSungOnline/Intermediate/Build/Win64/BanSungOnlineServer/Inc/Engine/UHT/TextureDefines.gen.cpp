...
struct Z_Construct_UEnum_Engine_ETextureSourceCompressionFormat_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "TSCF_UEDELTA.DisplayName", "UE Delta" },
		{ "TSCF_UEDELTA.Name", "TSCF_UEDELTA" },
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "TSCF_UEDELTA", (int64)TSCF_UEDELTA },
...
struct Z_Construct_UEnum_Engine_ETextureSourceFormat_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "TSF_RGBA8_DEPRECATED.Comment", "// these are changed to TSF_BGRA8/TSF_BGRE8 on load, so the runtime will never see them after loading :\n// keep them here to preserve enum values\n" },
		{ "TSF_RGBA8_DEPRECATED.Name", "TSF_RGBA8_DEPRECATED" },
		{ "TSF_RGBA8_DEPRECATED.ToolTip", "these are changed to TSF_BGRA8/TSF_BGRE8 on load, so the runtime will never see them after loading :\nkeep them here to preserve enum values" },
...
struct Z_Construct_UEnum_Engine_TextureCompressionSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Classes/Engine/TextureDefines.h" },
		{ "TC_Alpha.DisplayName", "Alpha (no sRGB, BC4)" },
		{ "TC_Alpha.Name", "TC_Alpha" },
		{ "TC_BC7.DisplayName", "BC7 (RGBA)" },
		{ "TC_BC7.Name", "TC_BC7" },
		{ "TC_Default.DisplayName", "Default (BC1 or BC3 with A)" },
		...
		{ "TC_EditorIcon.DisplayName", "UserInterface2D (RGBA8)" },
		...
		{ "TC_HDR.Name", "TC_HDR" },
		{ "TC_HDR_Compressed.DisplayName", "HDR Compressed (RGB, BC6H)" },
		...
		{ "TC_MAX.Name", "TC_MAX" },
		{ "TC_Normalmap.DisplayName", "Normalmap (BC5)" },
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_TextureDefines_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		...
		{ ETextureSourceCompressionFormat_StaticEnum, TEXT("ETextureSourceCompressionFormat"), &Z_Registration_Info_UEnum_ETextureSourceCompressionFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 965129639U) },
		{ ETextureSourceFormat_StaticEnum, TEXT("ETextureSourceFormat"), &Z_Registration_Info_UEnum_ETextureSourceFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3865012508U) },
		{ TextureCompressionSettings_StaticEnum, TEXT("TextureCompressionSettings"), &Z_Registration_Info_UEnum_TextureCompressionSettings, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2123615340U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_TextureDefines_h_1450194487(TEXT("/Script/Engine"),
	nullptr, 0,
	nullptr, 0,

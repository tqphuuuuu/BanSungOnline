...
template<> ENGINE_API UScriptStruct* StaticStruct<struct FSoundSubmixSendInfoBase>();

#define FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundSubmixSend_h_143_GENERATED_BODY \

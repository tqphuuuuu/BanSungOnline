...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Engine_Beam2SourceTargetMethod_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_Beam2SourceTargetMethod_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Engine_Beam2SourceTargetMethod_Statics::Enum_MetaDataParams)
};
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Engine_Beam2SourceTargetTangentMethod_Statics::EnumParams = {
	...
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::Regular,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_Beam2SourceTargetTangentMethod_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Engine_Beam2SourceTargetTangentMethod_Statics::Enum_MetaDataParams)
};
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleBeamBase_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleBeamBase_Statics::ClassParams = {
	...
	0,
	0x000010A1u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleBeamBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UParticleModuleBeamBase_Statics::Class_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Beam_ParticleModuleBeamBase_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ Beam2SourceTargetMethod_StaticEnum, TEXT("Beam2SourceTargetMethod"), &Z_Registration_Info_UEnum_Beam2SourceTargetMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2452332023U) },
		{ Beam2SourceTargetTangentMethod_StaticEnum, TEXT("Beam2SourceTargetTangentMethod"), &Z_Registration_Info_UEnum_Beam2SourceTargetTangentMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1216000768U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleBeamBase, UParticleModuleBeamBase::StaticClass, TEXT("UParticleModuleBeamBase"), &Z_Registration_Info_UClass_UParticleModuleBeamBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleBeamBase), 3371174635U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Beam_ParticleModuleBeamBase_h_4082647731(TEXT("/Script/Engine"),

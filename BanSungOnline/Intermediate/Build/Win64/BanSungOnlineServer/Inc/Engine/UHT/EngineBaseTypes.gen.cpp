...
struct Z_Construct_UEnum_Engine_EViewModeIndex_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "VMI_Lit_Wireframe.Comment", "/** Lit Wireframe. */" },
		{ "VMI_Lit_Wireframe.DisplayName", "Lit Wireframe" },
		{ "VMI_Lit_Wireframe.Name", "VMI_Lit_Wireframe" },
		{ "VMI_Lit_Wireframe.ToolTip", "Lit Wireframe." },
		...
		{ "VMI_LWCComplexity.DisplayName", "Material LWC Function Usage" },
		{ "VMI_LWCComplexity.Name", "VMI_LWCComplexity" },
		...
		{ "VMI_VisualizeActorColoration.Comment", "/** Visualize Actor Coloration. */" },
		{ "VMI_VisualizeActorColoration.DisplayName", "Actor Coloration Visualization" },
		{ "VMI_VisualizeActorColoration.Name", "VMI_VisualizeActorColoration" },
		{ "VMI_VisualizeActorColoration.ToolTip", "Visualize Actor Coloration." },
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "VMI_LWCComplexity", (int64)VMI_LWCComplexity },
		{ "VMI_Lit_Wireframe", (int64)VMI_Lit_Wireframe },
		{ "VMI_VisualizeActorColoration", (int64)VMI_VisualizeActorColoration },
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_EngineBaseTypes_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		...
		{ EViewModeIndex_StaticEnum, TEXT("EViewModeIndex"), &Z_Registration_Info_UEnum_EViewModeIndex, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1951490823U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_EngineBaseTypes_h_1850364735(TEXT("/Script/Engine"),

...
#include "Runtime/Engine/Private/Tests/Loading/AsyncLoadingTests_Shared.h"
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAsyncLoadingTests_Shared);
UClass* Z_Construct_UClass_UAsyncLoadingTests_Shared_NoRegister()
{
	return UAsyncLoadingTests_Shared::StaticClass();
}
...
template<> ENGINE_API UClass* StaticClass<UAsyncLoadingTests_Shared>()
{
	return UAsyncLoadingTests_Shared::StaticClass();
}
UAsyncLoadingTests_Shared::UAsyncLoadingTests_Shared(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
DEFINE_VTABLE_PTR_HELPER_CTOR(UAsyncLoadingTests_Shared);
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Private_Tests_Loading_AsyncLoadingTests_Shared_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAsyncLoadingTests_Shared, UAsyncLoadingTests_Shared::StaticClass, TEXT("UAsyncLoadingTests_Shared"), &Z_Registration_Info_UClass_UAsyncLoadingTests_Shared, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAsyncLoadingTests_Shared), 2059470533U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Private_Tests_Loading_AsyncLoadingTests_Shared_h_2019972088(TEXT("/Script/Engine"),
	Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Private_Tests_Loading_AsyncLoadingTests_Shared_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Private_Tests_Loading_AsyncLoadingTests_Shared_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration

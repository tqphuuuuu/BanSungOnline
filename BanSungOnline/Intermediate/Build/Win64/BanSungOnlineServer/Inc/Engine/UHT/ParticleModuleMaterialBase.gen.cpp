...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleMaterialBase_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleMaterialBase_Statics::ClassParams = {
	...
	0,
	0x000010A1u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleMaterialBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UParticleModuleMaterialBase_Statics::Class_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Material_ParticleModuleMaterialBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleMaterialBase, UParticleModuleMaterialBase::StaticClass, TEXT("UParticleModuleMaterialBase"), &Z_Registration_Info_UClass_UParticleModuleMaterialBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleMaterialBase), 4086951742U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Material_ParticleModuleMaterialBase_h_1334278030(TEXT("/Script/Engine"),

...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Engine_EParticleAxisLock_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_EParticleAxisLock_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Engine_EParticleAxisLock_Statics::Enum_MetaDataParams)
};
...
struct Z_Construct_UClass_UParticleModuleOrientationAxisLock_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_LockAxisFlags_MetaData[] = {
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrientationAxisLock_Statics::PropPointers) < 2048);
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrientationAxisLock_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleOrientationAxisLock_Statics::ClassParams = {
	...
	0,
	0x000810A0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrientationAxisLock_Statics::Class_MetaDataParams), Z_Construct_UClass_UParticleModuleOrientationAxisLock_Statics::Class_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Orientation_ParticleModuleOrientationAxisLock_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EParticleAxisLock_StaticEnum, TEXT("EParticleAxisLock"), &Z_Registration_Info_UEnum_EParticleAxisLock, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2670916187U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleOrientationAxisLock, UParticleModuleOrientationAxisLock::StaticClass, TEXT("UParticleModuleOrientationAxisLock"), &Z_Registration_Info_UClass_UParticleModuleOrientationAxisLock, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleOrientationAxisLock), 1099411709U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Orientation_ParticleModuleOrientationAxisLock_h_1987347947(TEXT("/Script/Engine"),

...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_RigidBodyBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ARigidBodyBase, ARigidBodyBase::StaticClass, TEXT("ARigidBodyBase"), &Z_Registration_Info_UClass_ARigidBodyBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARigidBodyBase), 3104140272U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_RigidBodyBase_h_4080774215(TEXT("/Script/Engine"),

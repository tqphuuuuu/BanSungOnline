...
public: \
	DECLARE_CLASS(ADebugCameraHUD, AHUD, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), ENGINE_API) \
...
private: \
	...
	ADebugCameraHUD(const ADebugCameraHUD&); \
public: \

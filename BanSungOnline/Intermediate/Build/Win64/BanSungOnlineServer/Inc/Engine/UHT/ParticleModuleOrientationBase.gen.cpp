...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrientationBase_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleOrientationBase_Statics::ClassParams = {
	...
	0,
	0x000010A1u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrientationBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UParticleModuleOrientationBase_Statics::Class_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Orientation_ParticleModuleOrientationBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleOrientationBase, UParticleModuleOrientationBase::StaticClass, TEXT("UParticleModuleOrientationBase"), &Z_Registration_Info_UClass_UParticleModuleOrientationBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleOrientationBase), 376888417U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Orientation_ParticleModuleOrientationBase_h_2402806576(TEXT("/Script/Engine"),

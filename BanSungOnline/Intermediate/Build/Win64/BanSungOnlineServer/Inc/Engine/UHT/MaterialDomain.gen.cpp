...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Engine_EMaterialDomain_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_EMaterialDomain_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Engine_EMaterialDomain_Statics::Enum_MetaDataParams)
};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialDomain_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EMaterialDomain_StaticEnum, TEXT("EMaterialDomain"), &Z_Registration_Info_UEnum_EMaterialDomain, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1070349904U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialDomain_h_2545346298(TEXT("/Script/Engine"),
	nullptr, 0,
	nullptr, 0,

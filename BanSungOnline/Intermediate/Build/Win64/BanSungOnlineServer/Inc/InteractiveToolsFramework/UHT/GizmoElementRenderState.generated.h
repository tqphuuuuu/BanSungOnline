...
template<> INTERACTIVETOOLSFRAMEWORK_API UScriptStruct* StaticStruct<struct FGizmoElementColorAttribute>();
...
template<> INTERACTIVETOOLSFRAMEWORK_API UScriptStruct* StaticStruct<struct FGizmoElementMaterialAttribute>();

#define FID_Engine_Source_Runtime_InteractiveToolsFramework_Public_BaseGizmos_GizmoElementRenderState_h_91_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FGizmoElementMeshRenderStateAttributes_Statics; \
	INTERACTIVETOOLSFRAMEWORK_API static class UScriptStruct* StaticStruct();


template<> INTERACTIVETOOLSFRAMEWORK_API UScriptStruct* StaticStruct<struct FGizmoElementMeshRenderStateAttributes>();

#define FID_Engine_Source_Runtime_InteractiveToolsFramework_Public_BaseGizmos_GizmoElementRenderState_h_133_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FGizmoElementLineRenderStateAttributes_Statics; \
	INTERACTIVETOOLSFRAMEWORK_API static class UScriptStruct* StaticStruct();


template<> INTERACTIVETOOLSFRAMEWORK_API UScriptStruct* StaticStruct<struct FGizmoElementLineRenderStateAttributes>();

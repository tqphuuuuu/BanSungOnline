...
#include "Runtime/InteractiveToolsFramework/Public/BaseGizmos/GizmoElementShared.h"
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_InteractiveToolsFramework_Public_BaseGizmos_GizmoElementShared_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EGizmoElementState_StaticEnum, TEXT("EGizmoElementState"), &Z_Registration_Info_UEnum_EGizmoElementState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3960190341U) },
		{ EGizmoElementInteractionState_StaticEnum, TEXT("EGizmoElementInteractionState"), &Z_Registration_Info_UEnum_EGizmoElementInteractionState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2190655602U) },
		{ EGizmoElementViewDependentType_StaticEnum, TEXT("EGizmoElementViewDependentType"), &Z_Registration_Info_UEnum_EGizmoElementViewDependentType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3860216403U) },
		{ EGizmoElementViewAlignType_StaticEnum, TEXT("EGizmoElementViewAlignType"), &Z_Registration_Info_UEnum_EGizmoElementViewAlignType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3740679907U) },
		{ EGizmoElementPartialType_StaticEnum, TEXT("EGizmoElementPartialType"), &Z_Registration_Info_UEnum_EGizmoElementPartialType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 465377321U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_InteractiveToolsFramework_Public_BaseGizmos_GizmoElementShared_h_4233643569(TEXT("/Script/InteractiveToolsFramework"),
	nullptr, 0,
	nullptr, 0,

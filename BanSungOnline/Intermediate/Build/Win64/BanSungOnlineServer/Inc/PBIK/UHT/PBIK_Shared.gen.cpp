...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FPBIKBoneSetting_Statics::NewProp_Y = { "Y", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPBIKBoneSetting, Y), Z_Construct_UEnum_PBIK_EPBIKLimitType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Y_MetaData), NewProp_Y_MetaData) }; // 1524420979
...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_FullBodyIK_Source_PBIK_Public_PBIK_Shared_h_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FPBIKBoneSetting::StaticStruct, Z_Construct_UScriptStruct_FPBIKBoneSetting_Statics::NewStructOps, TEXT("PBIKBoneSetting"), &Z_Registration_Info_UScriptStruct_PBIKBoneSetting, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPBIKBoneSetting), 1073528506U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_FullBodyIK_Source_PBIK_Public_PBIK_Shared_h_1895352268(TEXT("/Script/PBIK"),
	nullptr, 0,

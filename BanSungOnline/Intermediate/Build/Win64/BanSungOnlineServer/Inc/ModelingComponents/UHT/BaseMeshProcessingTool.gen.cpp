...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_BaseTools_BaseMeshProcessingTool_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBaseMeshProcessingToolBuilder, UBaseMeshProcessingToolBuilder::StaticClass, TEXT("UBaseMeshProcessingToolBuilder"), &Z_Registration_Info_UClass_UBaseMeshProcessingToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBaseMeshProcessingToolBuilder), 2927134545U) },
		{ Z_Construct_UClass_UBaseMeshProcessingTool, UBaseMeshProcessingTool::StaticClass, TEXT("UBaseMeshProcessingTool"), &Z_Registration_Info_UClass_UBaseMeshProcessingTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBaseMeshProcessingTool), 1739830695U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_BaseTools_BaseMeshProcessingTool_h_1212075439(TEXT("/Script/ModelingComponents"),

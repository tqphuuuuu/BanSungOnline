...
#define FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_IOptimusUnnamedNodePinProvider_h_15_ENHANCED_CONSTRUCTORS \
	...
	NO_API UOptimusUnnamedNodePinProvider(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UOptimusUnnamedNodePinProvider(UOptimusUnnamedNodePinProvider&&); \
	UOptimusUnnamedNodePinProvider(const UOptimusUnnamedNodePinProvider&); \
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UOptimusUnnamedNodePinProvider); \
	...
	NO_API virtual ~UOptimusUnnamedNodePinProvider();
...
public: \
	DECLARE_CLASS(UOptimusUnnamedNodePinProvider, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/OptimusCore"), NO_API) \
...
template<> OPTIMUSCORE_API UClass* StaticClass<class UOptimusUnnamedNodePinProvider>();

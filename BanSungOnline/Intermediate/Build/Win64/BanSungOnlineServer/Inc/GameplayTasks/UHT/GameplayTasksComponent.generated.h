...
public: \
	DECLARE_CLASS(UGameplayTasksComponent, UActorComponent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/GameplayTasks"), GAMEPLAYTASKS_API) \
	...
	GAMEPLAYTASKS_API virtual void ValidateGeneratedRepEnums(const TArray<struct FRepRecord>& ClassReps) const override;
...
private: \
	...
	UGameplayTasksComponent(const UGameplayTasksComponent&); \
public: \

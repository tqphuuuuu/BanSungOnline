...
UScriptStruct* Z_Construct_UScriptStruct_FMappingQueryIssue()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_MappingQueryIssue.InnerSingleton, Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::StructParams);
	}
...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EMappingQueryResult_StaticEnum, TEXT("EMappingQueryResult"), &Z_Registration_Info_UEnum_EMappingQueryResult, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1462134381U) },
		{ EMappingQueryIssue_StaticEnum, TEXT("EMappingQueryIssue"), &Z_Registration_Info_UEnum_EMappingQueryIssue, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3081233225U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMappingQueryIssue::StaticStruct, Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewStructOps, TEXT("MappingQueryIssue"), &Z_Registration_Info_UScriptStruct_MappingQueryIssue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMappingQueryIssue), 186197119U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_1968575842(TEXT("/Script/EnhancedInput"),
	nullptr, 0,

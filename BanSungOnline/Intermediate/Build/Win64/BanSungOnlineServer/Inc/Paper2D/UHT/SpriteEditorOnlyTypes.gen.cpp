...
UScriptStruct* Z_Construct_UScriptStruct_FSpriteGeometryShape()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_SpriteGeometryShape.InnerSingleton, Z_Construct_UScriptStruct_FSpriteGeometryShape_Statics::StructParams);
	}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSpriteGeometryCollection_Statics::NewProp_Shapes_Inner = { "Shapes", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FSpriteGeometryShape, METADATA_PARAMS(0, nullptr) }; // 344921128
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSpriteGeometryCollection_Statics::NewProp_Shapes = { "Shapes", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSpriteGeometryCollection, Shapes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Shapes_MetaData), NewProp_Shapes_MetaData) }; // 344921128
const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSpriteGeometryCollection_Statics::NewProp_GeometryType = { "GeometryType", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSpriteGeometryCollection, GeometryType), Z_Construct_UEnum_Paper2D_ESpritePolygonMode, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GeometryType_MetaData), NewProp_GeometryType_MetaData) }; // 3736220742
...
UScriptStruct* Z_Construct_UScriptStruct_FSpriteGeometryCollection()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_SpriteGeometryCollection.InnerSingleton, Z_Construct_UScriptStruct_FSpriteGeometryCollection_Statics::StructParams);
	}
...
UScriptStruct* Z_Construct_UScriptStruct_FSpriteAssetInitParameters()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_SpriteAssetInitParameters.InnerSingleton, Z_Construct_UScriptStruct_FSpriteAssetInitParameters_Statics::StructParams);
	}
...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_SpriteEditorOnlyTypes_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESpriteCollisionMode_StaticEnum, TEXT("ESpriteCollisionMode"), &Z_Registration_Info_UEnum_ESpriteCollisionMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3506429279U) },
		{ ESpriteShapeType_StaticEnum, TEXT("ESpriteShapeType"), &Z_Registration_Info_UEnum_ESpriteShapeType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1474435478U) },
		{ ESpritePolygonMode_StaticEnum, TEXT("ESpritePolygonMode"), &Z_Registration_Info_UEnum_ESpritePolygonMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3736220742U) },
		{ ESpritePivotMode_StaticEnum, TEXT("ESpritePivotMode"), &Z_Registration_Info_UEnum_ESpritePivotMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1840517934U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FSpriteGeometryShape::StaticStruct, Z_Construct_UScriptStruct_FSpriteGeometryShape_Statics::NewStructOps, TEXT("SpriteGeometryShape"), &Z_Registration_Info_UScriptStruct_SpriteGeometryShape, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSpriteGeometryShape), 344921128U) },
		{ FSpriteGeometryCollection::StaticStruct, Z_Construct_UScriptStruct_FSpriteGeometryCollection_Statics::NewStructOps, TEXT("SpriteGeometryCollection"), &Z_Registration_Info_UScriptStruct_SpriteGeometryCollection, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSpriteGeometryCollection), 826102719U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_SpriteEditorOnlyTypes_h_1201752691(TEXT("/Script/Paper2D"),
	nullptr, 0,

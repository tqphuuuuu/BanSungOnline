...
template<> CHAOS_API UEnum* StaticEnum<EDamageModelTypeEnum>()
{
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Chaos_Public_GeometryCollection_GeometryCollectionSimulationTypes_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ECollisionTypeEnum_StaticEnum, TEXT("ECollisionTypeEnum"), &Z_Registration_Info_UEnum_ECollisionTypeEnum, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2902345281U) },
		{ EImplicitTypeEnum_StaticEnum, TEXT("EImplicitTypeEnum"), &Z_Registration_Info_UEnum_EImplicitTypeEnum, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1153760466U) },
		{ EObjectStateTypeEnum_StaticEnum, TEXT("EObjectStateTypeEnum"), &Z_Registration_Info_UEnum_EObjectStateTypeEnum, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1227595032U) },
		{ EGeometryCollectionPhysicsTypeEnum_StaticEnum, TEXT("EGeometryCollectionPhysicsTypeEnum"), &Z_Registration_Info_UEnum_EGeometryCollectionPhysicsTypeEnum, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3963894825U) },
		{ EInitialVelocityTypeEnum_StaticEnum, TEXT("EInitialVelocityTypeEnum"), &Z_Registration_Info_UEnum_EInitialVelocityTypeEnum, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1463678991U) },
		{ EEmissionPatternTypeEnum_StaticEnum, TEXT("EEmissionPatternTypeEnum"), &Z_Registration_Info_UEnum_EEmissionPatternTypeEnum, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3324874178U) },
		{ EDamageModelTypeEnum_StaticEnum, TEXT("EDamageModelTypeEnum"), &Z_Registration_Info_UEnum_EDamageModelTypeEnum, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1555958943U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Chaos_Public_GeometryCollection_GeometryCollectionSimulationTypes_h_3159324103(TEXT("/Script/Chaos"),
	nullptr, 0,
	nullptr, 0,

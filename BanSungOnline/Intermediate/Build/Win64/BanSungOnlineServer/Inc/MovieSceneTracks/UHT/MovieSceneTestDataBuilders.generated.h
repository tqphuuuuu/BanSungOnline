...
public: \
	DECLARE_CLASS(UMovieSceneTestSequence, UMovieSceneSequence, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/MovieSceneTracks"), MOVIESCENETRACKS_API) \
...
private: \
	...
	UMovieSceneTestSequence(const UMovieSceneTestSequence&); \
public: \
...
template<> MOVIESCENETRACKS_API UClass* StaticClass<class UMovieSceneTestSequence>();

...
private: \
	...
	UMovieSceneConsoleVariableTrackInterface(const UMovieSceneConsoleVariableTrackInterface&); \
public: \
	...
	MOVIESCENETRACKS_API virtual ~UMovieSceneConsoleVariableTrackInterface();
...
public: \
	DECLARE_CLASS(UMovieSceneConsoleVariableTrackInterface, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/MovieSceneTracks"), MOVIESCENETRACKS_API) \
...
template<> MOVIESCENETRACKS_API UClass* StaticClass<class UMovieSceneConsoleVariableTrackInterface>();

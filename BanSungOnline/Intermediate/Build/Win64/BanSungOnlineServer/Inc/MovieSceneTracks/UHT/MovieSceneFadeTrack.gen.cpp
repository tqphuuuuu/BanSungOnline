...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneFadeTrack_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneFadeTrack, UMovieSceneFadeTrack::StaticClass, TEXT("UMovieSceneFadeTrack"), &Z_Registration_Info_UClass_UMovieSceneFadeTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneFadeTrack), 2375596481U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneFadeTrack_h_1981494217(TEXT("/Script/MovieSceneTracks"),

...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingOperators_Public_CleaningOps_EditNormalsOp_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ENormalCalculationMethod_StaticEnum, TEXT("ENormalCalculationMethod"), &Z_Registration_Info_UEnum_ENormalCalculationMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1528077686U) },
		{ ESplitNormalMethod_StaticEnum, TEXT("ESplitNormalMethod"), &Z_Registration_Info_UEnum_ESplitNormalMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 252700879U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingOperators_Public_CleaningOps_EditNormalsOp_h_3466248543(TEXT("/Script/ModelingOperators"),
	nullptr, 0,
	nullptr, 0,

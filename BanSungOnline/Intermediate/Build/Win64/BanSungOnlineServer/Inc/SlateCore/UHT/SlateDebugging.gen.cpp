...
#include "Runtime/SlateCore/Public/Debugging/SlateDebugging.h"
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Debugging_SlateDebugging_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESlateDebuggingInputEvent_StaticEnum, TEXT("ESlateDebuggingInputEvent"), &Z_Registration_Info_UEnum_ESlateDebuggingInputEvent, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2592855056U) },
		{ ESlateDebuggingStateChangeEvent_StaticEnum, TEXT("ESlateDebuggingStateChangeEvent"), &Z_Registration_Info_UEnum_ESlateDebuggingStateChangeEvent, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3044900484U) },
		{ ESlateDebuggingNavigationMethod_StaticEnum, TEXT("ESlateDebuggingNavigationMethod"), &Z_Registration_Info_UEnum_ESlateDebuggingNavigationMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1571949248U) },
		{ ESlateDebuggingFocusEvent_StaticEnum, TEXT("ESlateDebuggingFocusEvent"), &Z_Registration_Info_UEnum_ESlateDebuggingFocusEvent, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3142544734U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Debugging_SlateDebugging_h_3296708274(TEXT("/Script/SlateCore"),
	nullptr, 0,
	nullptr, 0,

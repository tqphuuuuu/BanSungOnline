...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Types_SlateEnums_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EButtonClickMethod_StaticEnum, TEXT("EButtonClickMethod"), &Z_Registration_Info_UEnum_EButtonClickMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1764969274U) },
		{ EButtonTouchMethod_StaticEnum, TEXT("EButtonTouchMethod"), &Z_Registration_Info_UEnum_EButtonTouchMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 601106521U) },
		{ EButtonPressMethod_StaticEnum, TEXT("EButtonPressMethod"), &Z_Registration_Info_UEnum_EButtonPressMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 724634847U) },
		{ EUINavigation_StaticEnum, TEXT("EUINavigation"), &Z_Registration_Info_UEnum_EUINavigation, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2993106650U) },
		{ EUINavigationAction_StaticEnum, TEXT("EUINavigationAction"), &Z_Registration_Info_UEnum_EUINavigationAction, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3797654294U) },
		{ ENavigationSource_StaticEnum, TEXT("ENavigationSource"), &Z_Registration_Info_UEnum_ENavigationSource, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2783119079U) },
		{ ENavigationGenesis_StaticEnum, TEXT("ENavigationGenesis"), &Z_Registration_Info_UEnum_ENavigationGenesis, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 582603674U) },
		{ EHorizontalAlignment_StaticEnum, TEXT("EHorizontalAlignment"), &Z_Registration_Info_UEnum_EHorizontalAlignment, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1062133256U) },
		{ EVerticalAlignment_StaticEnum, TEXT("EVerticalAlignment"), &Z_Registration_Info_UEnum_EVerticalAlignment, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 550775363U) },
		{ EMenuPlacement_StaticEnum, TEXT("EMenuPlacement"), &Z_Registration_Info_UEnum_EMenuPlacement, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3213112757U) },
		{ EOrientation_StaticEnum, TEXT("EOrientation"), &Z_Registration_Info_UEnum_EOrientation, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 349032367U) },
		{ EScrollDirection_StaticEnum, TEXT("EScrollDirection"), &Z_Registration_Info_UEnum_EScrollDirection, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1012008580U) },
		{ ETextCommit_StaticEnum, TEXT("ETextCommit"), &Z_Registration_Info_UEnum_ETextCommit, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1817921380U) },
		{ ESelectInfo_StaticEnum, TEXT("ESelectInfo"), &Z_Registration_Info_UEnum_ESelectInfo, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4040429206U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Types_SlateEnums_h_516498790(TEXT("/Script/SlateCore"),
	nullptr, 0,
	nullptr, 0,

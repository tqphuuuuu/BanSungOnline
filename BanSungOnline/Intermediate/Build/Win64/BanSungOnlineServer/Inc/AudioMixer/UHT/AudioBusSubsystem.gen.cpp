...
#include "Runtime/AudioMixer/Public/AudioBusSubsystem.h"
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioMixer_Public_AudioBusSubsystem_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAudioBusSubsystem, UAudioBusSubsystem::StaticClass, TEXT("UAudioBusSubsystem"), &Z_Registration_Info_UClass_UAudioBusSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioBusSubsystem), 603225137U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioMixer_Public_AudioBusSubsystem_h_3588499665(TEXT("/Script/AudioMixer"),

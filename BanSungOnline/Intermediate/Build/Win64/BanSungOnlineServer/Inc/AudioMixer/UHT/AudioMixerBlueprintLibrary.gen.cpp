...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSwapAudioOutputResult_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSwapAudioOutputResult, Result), Z_Construct_UEnum_AudioMixer_ESwapAudioOutputDeviceResultState, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Result_MetaData), NewProp_Result_MetaData) }; // 4151238488
...
UScriptStruct* Z_Construct_UScriptStruct_FSwapAudioOutputResult()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_SwapAudioOutputResult.InnerSingleton, Z_Construct_UScriptStruct_FSwapAudioOutputResult_Statics::StructParams);
	}
...
UScriptStruct* Z_Construct_UScriptStruct_FAudioOutputDeviceInfo()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_AudioOutputDeviceInfo.InnerSingleton, Z_Construct_UScriptStruct_FAudioOutputDeviceInfo_Statics::StructParams);
	}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_AudioMixer_OnCompletedDeviceSwap__DelegateSignature_Statics::NewProp_SwapResult = { "SwapResult", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_AudioMixer_eventOnCompletedDeviceSwap_Parms, SwapResult), Z_Construct_UScriptStruct_FSwapAudioOutputResult, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SwapResult_MetaData), NewProp_SwapResult_MetaData) }; // 556524030
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioMixerBlueprintLibrary_GetCurrentAudioOutputDeviceName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioMixerBlueprintLibrary, nullptr, "GetCurrentAudioOutputDeviceName", nullptr, nullptr, Z_Construct_UFunction_UAudioMixerBlueprintLibrary_GetCurrentAudioOutputDeviceName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_GetCurrentAudioOutputDeviceName_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_GetCurrentAudioOutputDeviceName_Statics::AudioMixerBlueprintLibrary_eventGetCurrentAudioOutputDeviceName_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422403, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_GetCurrentAudioOutputDeviceName_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAudioMixerBlueprintLibrary_GetCurrentAudioOutputDeviceName_Statics::Function_MetaDataParams) };
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UAudioMixerBlueprintLibrary_MakePresetSpectralAnalysisBandSettings_Statics::NewProp_InBandPresetType = { "InBandPresetType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AudioMixerBlueprintLibrary_eventMakePresetSpectralAnalysisBandSettings_Parms, InBandPresetType), Z_Construct_UEnum_Engine_EAudioSpectrumBandPresetType, METADATA_PARAMS(0, nullptr) }; // 1367109381
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RemoveSubmixEffectPreset_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioMixerBlueprintLibrary, nullptr, "RemoveSubmixEffectPreset", nullptr, nullptr, Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RemoveSubmixEffectPreset_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RemoveSubmixEffectPreset_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RemoveSubmixEffectPreset_Statics::AudioMixerBlueprintLibrary_eventRemoveSubmixEffectPreset_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022403, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RemoveSubmixEffectPreset_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RemoveSubmixEffectPreset_Statics::Function_MetaDataParams) };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioMixerBlueprintLibrary_StopAudioBus_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioMixerBlueprintLibrary, nullptr, "StopAudioBus", nullptr, nullptr, Z_Construct_UFunction_UAudioMixerBlueprintLibrary_StopAudioBus_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_StopAudioBus_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_StopAudioBus_Statics::AudioMixerBlueprintLibrary_eventStopAudioBus_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022403, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_StopAudioBus_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAudioMixerBlueprintLibrary_StopAudioBus_Statics::Function_MetaDataParams) };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioMixerBlueprintLibrary_TrimAudioCache_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioMixerBlueprintLibrary, nullptr, "TrimAudioCache", nullptr, nullptr, Z_Construct_UFunction_UAudioMixerBlueprintLibrary_TrimAudioCache_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_TrimAudioCache_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_TrimAudioCache_Statics::AudioMixerBlueprintLibrary_eventTrimAudioCache_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022403, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_TrimAudioCache_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAudioMixerBlueprintLibrary_TrimAudioCache_Statics::Function_MetaDataParams) };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioMixerBlueprintLibrary_UnregisterAudioBusFromSubmix_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioMixerBlueprintLibrary, nullptr, "UnregisterAudioBusFromSubmix", nullptr, nullptr, Z_Construct_UFunction_UAudioMixerBlueprintLibrary_UnregisterAudioBusFromSubmix_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_UnregisterAudioBusFromSubmix_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_UnregisterAudioBusFromSubmix_Statics::AudioMixerBlueprintLibrary_eventUnregisterAudioBusFromSubmix_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022403, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioMixerBlueprintLibrary_UnregisterAudioBusFromSubmix_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAudioMixerBlueprintLibrary_UnregisterAudioBusFromSubmix_Statics::Function_MetaDataParams) };
...
void UAudioMixerBlueprintLibrary::StaticRegisterNativesUAudioMixerBlueprintLibrary()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "RegisterAudioBusToSubmix", &UAudioMixerBlueprintLibrary::execRegisterAudioBusToSubmix },
		...
		{ "UnregisterAudioBusFromSubmix", &UAudioMixerBlueprintLibrary::execUnregisterAudioBusFromSubmix },
	};
...
struct Z_Construct_UClass_UAudioMixerBlueprintLibrary_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_AddMasterSubmixEffect, "AddMasterSubmixEffect" }, // 2130673175
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_AddSourceEffectToPresetChain, "AddSourceEffectToPresetChain" }, // 2641933634
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_AddSubmixEffect, "AddSubmixEffect" }, // 163754081
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_ClearMasterSubmixEffects, "ClearMasterSubmixEffects" }, // 1684258047
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_ClearSubmixEffectChainOverride, "ClearSubmixEffectChainOverride" }, // 941416515
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_ClearSubmixEffects, "ClearSubmixEffects" }, // 2547458742
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_Conv_AudioOutputDeviceInfoToString, "Conv_AudioOutputDeviceInfoToString" }, // 353878305
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_GetAvailableAudioOutputDevices, "GetAvailableAudioOutputDevices" }, // 2885794627
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_GetCurrentAudioOutputDeviceName, "GetCurrentAudioOutputDeviceName" }, // 1446919599
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_GetMagnitudeForFrequencies, "GetMagnitudeForFrequencies" }, // 2222185948
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_GetNumberOfEntriesInSourceEffectChain, "GetNumberOfEntriesInSourceEffectChain" }, // 2058960279
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_GetPhaseForFrequencies, "GetPhaseForFrequencies" }, // 4045817791
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_IsAudioBusActive, "IsAudioBusActive" }, // 846583967
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_MakeFullSpectrumSpectralAnalysisBandSettings, "MakeFullSpectrumSpectralAnalysisBandSettings" }, // 1437991499
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_MakeMusicalSpectralAnalysisBandSettings, "MakeMusicalSpectralAnalysisBandSettings" }, // 1896410955
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_MakePresetSpectralAnalysisBandSettings, "MakePresetSpectralAnalysisBandSettings" }, // 3013951035
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_PauseRecordingOutput, "PauseRecordingOutput" }, // 225780828
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_PrimeSoundCueForPlayback, "PrimeSoundCueForPlayback" }, // 39155028
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_PrimeSoundForPlayback, "PrimeSoundForPlayback" }, // 3106332869
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RegisterAudioBusToSubmix, "RegisterAudioBusToSubmix" }, // 2467445977
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RemoveMasterSubmixEffect, "RemoveMasterSubmixEffect" }, // 3622710903
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RemoveSourceEffectFromPresetChain, "RemoveSourceEffectFromPresetChain" }, // 3423555934
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RemoveSubmixEffect, "RemoveSubmixEffect" }, // 2152218587
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RemoveSubmixEffectAtIndex, "RemoveSubmixEffectAtIndex" }, // 1518337823
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RemoveSubmixEffectPreset, "RemoveSubmixEffectPreset" }, // 3697543838
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_RemoveSubmixEffectPresetAtIndex, "RemoveSubmixEffectPresetAtIndex" }, // 3009817154
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_ReplaceSoundEffectSubmix, "ReplaceSoundEffectSubmix" }, // 1698359620
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_ReplaceSubmixEffect, "ReplaceSubmixEffect" }, // 908709068
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_ResumeRecordingOutput, "ResumeRecordingOutput" }, // 522456605
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_SetBypassSourceEffectChainEntry, "SetBypassSourceEffectChainEntry" }, // 4125604493
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_SetSubmixEffectChainOverride, "SetSubmixEffectChainOverride" }, // 3838637603
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_StartAnalyzingOutput, "StartAnalyzingOutput" }, // 747996100
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_StartAudioBus, "StartAudioBus" }, // 2321416240
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_StartRecordingOutput, "StartRecordingOutput" }, // 1275428547
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_StopAnalyzingOutput, "StopAnalyzingOutput" }, // 814502135
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_StopAudioBus, "StopAudioBus" }, // 2853856507
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_StopRecordingOutput, "StopRecordingOutput" }, // 3397055098
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_SwapAudioOutputDevice, "SwapAudioOutputDevice" }, // 14474519
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_TrimAudioCache, "TrimAudioCache" }, // 1709008824
		{ &Z_Construct_UFunction_UAudioMixerBlueprintLibrary_UnregisterAudioBusFromSubmix, "UnregisterAudioBusFromSubmix" }, // 218441732
	};
...
struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioMixer_Public_AudioMixerBlueprintLibrary_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EMusicalNoteName_StaticEnum, TEXT("EMusicalNoteName"), &Z_Registration_Info_UEnum_EMusicalNoteName, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 958463829U) },
		{ EAudioMixerStreamDataFormatType_StaticEnum, TEXT("EAudioMixerStreamDataFormatType"), &Z_Registration_Info_UEnum_EAudioMixerStreamDataFormatType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 944772020U) },
		{ EAudioMixerChannelType_StaticEnum, TEXT("EAudioMixerChannelType"), &Z_Registration_Info_UEnum_EAudioMixerChannelType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 175696126U) },
		{ ESwapAudioOutputDeviceResultState_StaticEnum, TEXT("ESwapAudioOutputDeviceResultState"), &Z_Registration_Info_UEnum_ESwapAudioOutputDeviceResultState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4151238488U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FSwapAudioOutputResult::StaticStruct, Z_Construct_UScriptStruct_FSwapAudioOutputResult_Statics::NewStructOps, TEXT("SwapAudioOutputResult"), &Z_Registration_Info_UScriptStruct_SwapAudioOutputResult, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSwapAudioOutputResult), 556524030U) },
		{ FAudioOutputDeviceInfo::StaticStruct, Z_Construct_UScriptStruct_FAudioOutputDeviceInfo_Statics::NewStructOps, TEXT("AudioOutputDeviceInfo"), &Z_Registration_Info_UScriptStruct_AudioOutputDeviceInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAudioOutputDeviceInfo), 3924648275U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAudioMixerBlueprintLibrary, UAudioMixerBlueprintLibrary::StaticClass, TEXT("UAudioMixerBlueprintLibrary"), &Z_Registration_Info_UClass_UAudioMixerBlueprintLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioMixerBlueprintLibrary), 1287808951U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioMixer_Public_AudioMixerBlueprintLibrary_h_962912737(TEXT("/Script/AudioMixer"),

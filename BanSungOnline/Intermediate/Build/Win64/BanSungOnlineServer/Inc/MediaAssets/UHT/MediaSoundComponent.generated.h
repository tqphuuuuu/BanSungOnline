...
public: \
	DECLARE_CLASS(UMediaSoundComponent, USynthComponent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/MediaAssets"), MEDIAASSETS_API) \
...
private: \
	...
	UMediaSoundComponent(const UMediaSoundComponent&); \
public: \

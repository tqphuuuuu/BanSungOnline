...
struct Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraScriptSourceBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraScriptSourceBase, UNiagaraScriptSourceBase::StaticClass, TEXT("UNiagaraScriptSourceBase"), &Z_Registration_Info_UClass_UNiagaraScriptSourceBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraScriptSourceBase), 148871285U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraScriptSourceBase_h_519854796(TEXT("/Script/Niagara"),

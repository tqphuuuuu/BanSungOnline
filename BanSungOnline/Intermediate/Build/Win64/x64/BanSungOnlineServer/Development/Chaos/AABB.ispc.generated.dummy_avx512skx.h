//
// C:\\GameOnline\\BanSungOnline\\BanSungOnline\\Intermediate\\Build\\Win64\\x64\\BanSungOnlineServer\\Development\\Chaos\\AABB.ispc.generated.dummy_avx512skx.h
...
#else
    extern void TransformedAABB(const struct FTransform *SpaceTransform, const struct FVector *MMin, const struct FVector *MMax, struct FVector *NewMin, struct FVector *NewMax);
#endif // TransformedAABB function declaraion
#if defined(__cplusplus)
...
#else
    extern void TransformedAABB2(const struct FTransform *SpaceTransform, const struct FVector *MMin, const struct FVector *MMax, struct FVector *NewMin, struct FVector *NewMax);
#endif // TransformedAABB2 function declaraion
#if defined(__cplusplus)
...
#else
    extern void TransformedAABBMixed(const struct FTransform *SpaceTransform, const struct FVector3f *MMin, const struct FVector3f *MMax, struct FVector3f *NewMin, struct FVector3f *NewMax);
#endif // TransformedAABBMixed function declaraion
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
